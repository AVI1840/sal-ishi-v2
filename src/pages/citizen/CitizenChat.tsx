...
const AI_RESPONSES: { trigger: string[]; response: string; badge?: string }[] = [
  { trigger: ["בודד", "לבד", "בדידות"], response: "אני שומעת אותך, שרה ❤️ בדידות זה מרגש קשה. שמתי לב שאת אוהבת מוזיקה — יש חוג שירה מחר ב-10:00 במתנ״ס, עם 8 משתתפים שדומים לך. רוצה שאזמין מקום?", badge: "🎯 התאמה אישית" },
  ...
  { trigger: ["מה יש", "מה אפשר", "שירותים", "פעילויות"], response: "על בסיס הפרופיל שלך, הנה 3 המלצות מותאמות:\n\n🎨 חוג ציור — התאמה 94%\n🏊 שחייה טיפולית — התאמה 88%\n📚 מועדון קריאה — התאמה 85%\n\nכל אלה מסובסדים ב-100% מהסל שלך. על מה תרצי לשמוע עוד?", badge: "🧠 AI Recommendation" },
